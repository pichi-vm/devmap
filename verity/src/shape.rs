...
pub struct Shape {
    ...
    pub data_block_size: BlockSize<9>,
    /// Size of each hash-tree block.
    pub hash_block_size: BlockSize<9>,
...
impl Shape {
    ...
    #[must_use]
    pub const fn with_data_block_size(mut self, value: BlockSize<9>) -> Self {
        self.data_block_size = value;
        self
    }
    /// Changes the hash-block size.
    #[must_use]
    pub const fn with_hash_block_size(mut self, value: BlockSize<9>) -> Self {
